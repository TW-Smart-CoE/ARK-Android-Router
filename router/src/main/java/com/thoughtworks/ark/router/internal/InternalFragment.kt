...
import com.thoughtworks.ark.router.SchemeLauncherManager
...
class InternalFragment : Fragment() {
    companion object {
        ...
        fun FragmentActivity.awaitActivityResult(scheme: String, intent: Intent): Flow<Result<Bundle>> {
            val fragment = InternalFragment().apply {
    ...
    private val viewModel by lazy { ViewModelProvider(this)[InternalViewModel::class.java] }
    private val launcher = registerForActivityResult(StartActivityForResult()) {
        ...
        val launcher = SchemeLauncherManager.getLauncher(requireActivity().key(), scheme)
