...
internal fun FragmentActivity.createFragment(request: SchemeRequest): Fragment {
...
internal fun FragmentActivity.showNewFragment(request: SchemeRequest): Fragment {
...
private fun SchemeRequest.containerId(): Int {
    return if (containerViewId != 0) containerViewId else android.R.id.content
}

internal fun FragmentActivity.createDialogFragment(request: SchemeRequest): DialogFragment {
